      ...
      <div className="flex flex-col-reverse md:flex-row">
        <div className="event-info md:w-2/3 w-auto mx-auto bg-white shadow-md rounded-md px-8 py-6 mb-4 md:mb-0 md:mr-4">
          ...
          <Link
            ...
            href="#"
            className="inline-block mt-4 px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300"
          >
            Join
          </Link>
        </div>
